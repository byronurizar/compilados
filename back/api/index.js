...
const CatalogoPublic=require("./components/catalogopublic/network");
const Categoria=require("./components/categoria/network");
const SubCategoria=require("./components/subcategoria/network");
const Prespuesto=require("./components/presupuesto/network");
const Perfil=require("./components/perfil/network");
const PerfilAcceso=require("./components/perfilacceso/network");
const Gasto=require("./components/gasto/network");
const Registro=require("./components/registro/network");
const Invitacion=require("./components/invitacion/network");
...
//Control Gastos
app.use('/api/ctl/catalogo', passport.authenticate('jwt', { session: false }), Catalogo);
app.use('/api/ctl/categoria', passport.authenticate('jwt', { session: false }), Categoria);
app.use('/api/ctl/subcategoria', passport.authenticate('jwt', { session: false }), SubCategoria);
app.use('/api/ctl/presupuesto', passport.authenticate('jwt', { session: false }), Prespuesto);
app.use('/api/ctl/perfil', passport.authenticate('jwt', { session: false }), Perfil);
app.use('/api/ctl/perfil/acceso', passport.authenticate('jwt', { session: false }), PerfilAcceso);
app.use('/api/ctl/gasto', passport.authenticate('jwt', { session: false }), Gasto);
app.use('/api/ctl/invitacion', passport.authenticate('jwt', { session: false }), Invitacion);
app.use('/api/ctl/registro', Registro);
app.use('/api/ctl/cat', CatalogoPublic);
