...
const Menus = [
  ...
  },
  {
    ...
    href: "/base/catalogo/presupuesto",
    icono: "",
    classes: "nav-item",
    type: "item",
    menu_padreId: 22,
...
const Parametros = [
  ...
  },
  {
    ...
    nombreGrupo: "CONFIG_EMPRESA",
    tipoDato: "N",
    nombreVariable: "horasVigenciaEnlace",
    valor: "1",
    descripcion: "Duración del link",
    usuario_crea: 1
  },
  {
    parametroId: 12,
    nombreGrupo: "CONFIG_EMPRESA",
    tipoDato: "S",
    nombreVariable: "urlConfirmacionCuenta",
    valor: "http://localhost:3001/app/auth/confirm",
    descripcion: "Url que resolvera la confirmación de la cuenta",
    usuario_crea: 1
  },
  {
    parametroId: 13,
    nombreGrupo: "CONFIG_EMPRESA",
    tipoDato: "N",
    nombreVariable: "horasVigenciaEnlaceInvitacion",
    valor: "24",
    descripcion: "Duración del link",
    usuario_crea: 1
  },
  {
    parametroId: 14,
    nombreGrupo: "CONFIG_OAUTH2_GMAIL",
    tipoDato: "S",
    nombreVariable: "user",
    valor: "urizarcode@gmail.com",
    descripcion: "Correo electrónico utilizado para la creación de api key para el envio de correos",
    usuario_crea: 1
  },
  {
    parametroId: 15,
    nombreGrupo: "CONFIG_OAUTH2_GMAIL",
    tipoDato: "S",
    nombreVariable: "clientId",
    valor: "816411810148-oasig0te5h1rphmpmlgc845ujd475v0g.apps.googleusercontent.com",
    descripcion: "clientId proporcionado por gmail",
    usuario_crea: 1
  },
  {
    parametroId: 16,
    nombreGrupo: "CONFIG_OAUTH2_GMAIL",
    tipoDato: "S",
    nombreVariable: "clientSecret",
    valor: "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",
    descripcion: "clientSecret proporcionado por gmail",
    usuario_crea: 1
  },
  {
    parametroId: 17,
    nombreGrupo: "CONFIG_OAUTH2_GMAIL",
    tipoDato: "S",
    nombreVariable: "refreshToken",
    valor: "1//049G_pM1vE39YCgYIARAAGAQSNwF-L9IrXN3BwpNC5NLEaHhj8ZbrP1V9osNfG1qOqm5efzaMKFExBvmz4lqX2Pi-l6Md2bxwL_4",
    descripcion: "refreshToken proporcionado por gmail",
    usuario_crea: 1
  },
  {
    parametroId: 18,
    nombreGrupo: "CONFIG_OAUTH2_GMAIL",
    tipoDato: "S",
    nombreVariable: "redirectUri",
    valor: "https://developers.google.com/oauthplayground",
    descripcion: "redirectUri proporcionado por gmail",
    usuario_crea: 1
  }
];
const listMeses = [
...
const listMonedas = [
  ...
  {
    monedaId: 7,
    descripcion: "COLON COSTARRICENSE",
    simbolo: "₡",
    usuario_crea: 1
  }
];
const listPerfilGrupoGasto = [
  {
    perfilId: 1,
    nombre: "ADMINISTRADOR",
    usuario_crea: 1
...
const listAccesoGrupoGasto = [
  {
    accesoId: 1,
    descripcion: "MOSTRAR CATALOGOS",
    usuario_crea: 1
  },
  {
    accesoId: 2,
  ...
  {
    accesoId: 3,
    descripcion: "ACTUALIZACION DE GASTOS",
    usuario_crea: 1
  },
  {
    accesoId: 4,
    descripcion: "REGISTRO DE CATEGORIAS",
    usuario_crea: 1
  },
  {
    accesoId: 5,
    descripcion: "ACTUALIZACION DE CATEGORIAS",
    usuario_crea: 1
  },
  {
    accesoId: 6,
    descripcion: "ELIMINACION DE CATEGORIAS",
    usuario_crea: 1
  },
  {
    accesoId: 7,
    descripcion: "REGISTRO DE PRESUPUESTO",
    usuario_crea: 1
  },
  {
    accesoId: 8,
    descripcion: "ACTUALIZACION DE PRESUPUESTO",
    usuario_crea: 1
  },
  {
    accesoId: 9,
    descripcion: "ELIMINACION DE PRESUPUESTO",
    usuario_crea: 1
  },
  {
    accesoId: 10,
    descripcion: "GRAFICAS DE GASTOS Y PRESUPUESTO POR RANGO DE FECHAS",
    usuario_crea: 1
  }
];
const listAccesoPerfilGrupoGasto = [
  {
    perfilId: 1,
    accesoId: 1,
    usuario_crea: 1
...
module.exports = {
  ...
  listMeses,
  listMonedas,
  listPerfilGrupoGasto,
  listAccesoGrupoGasto,
  listAccesoPerfilGrupoGasto
}