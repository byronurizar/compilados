...
//Control de Gastos
const CatMonedaModel = require("./models/cat_moneda");
const CatMesModel = require("./models/cat_mes");
const CatGrupoGastoModel = require("./models/cat_grupo_gasto");
const CatAccessoGrupoGastoModel = require("./models/cat_acceso_grupo_gasto");
//const CatPerfilGrupoGastoModel = require("./models/cat_perfil_grupo_gasto");
const PerfilAccesoGrupoGastoModel = require("./models/perfil_acceso_grupo_gasto");
const GrupoGastoUsuarioModel = require("./models/grupo_gasto_usuario");
const CatCategoriaGrupoGastoModel = require("./models/cat_categoria_grupo_gasto");
const SubCategoriaGrupoGastoModel = require("./models/cat_sub_categoria_grupo_gasto");
const CatPresupuestoGrupoGastoModel = require("./models/cat_presupuesto");
const PresupuestoDetalleGrupoGastoModel = require("./models/presupuesto_detalle");
const GastoGrupoGastoModel = require("./models/gasto");
const ConfirmarCuentaModel=require("./models/confirmar_cuenta");
const InvitacionGrupoGastoModel=require("./models/invitacion_grupo_gasto");
const UsuarioAccesoGrupoGastoModel=require("./models/usuario_acceso_grupo_gasto");
...
//Control de Gastos
const CatMoneda = CatMonedaModel(confiBd, Sequelize);
const CatMes = CatMesModel(confiBd, Sequelize);
const CatGrupoGasto = CatGrupoGastoModel(confiBd, Sequelize);
const CatAccessoGrupoGasto = CatAccessoGrupoGastoModel(confiBd, Sequelize);
//const CatPerfilGrupoGasto = CatPerfilGrupoGastoModel(confiBd, Sequelize);
//const PerfilAccesoGrupoGasto = PerfilAccesoGrupoGastoModel(confiBd, Sequelize);
const GrupoGastoUsuario = GrupoGastoUsuarioModel(confiBd, Sequelize);
const CatCategoriaGrupoGasto = CatCategoriaGrupoGastoModel(confiBd, Sequelize);
const SubCategoriaGrupoGasto = SubCategoriaGrupoGastoModel(confiBd, Sequelize);
const CatPresupuestoGrupoGasto = CatPresupuestoGrupoGastoModel(confiBd, Sequelize);
const PresupuestoDetalleGrupoGasto = PresupuestoDetalleGrupoGastoModel(confiBd, Sequelize);
const GastoGrupoGasto = GastoGrupoGastoModel(confiBd, Sequelize);
const ConfirmarCuenta = ConfirmarCuentaModel(confiBd, Sequelize);
const InvitacionGrupoGasto=InvitacionGrupoGastoModel(confiBd, Sequelize);
const UsuarioAccesoGrupoGasto=UsuarioAccesoGrupoGastoModel(confiBd, Sequelize);
...
//Control de Gastos
CatCategoriaGrupoGasto.belongsTo(Estado, {
  as: "Estado",
  foreignKey: "estadoId",
  onDelete: "CASCADE",
});

SubCategoriaGrupoGasto.belongsTo(Estado, {
  as: "Estado",
  foreignKey: "estadoId",
  onDelete: "CASCADE",
});

SubCategoriaGrupoGasto.belongsTo(CatCategoriaGrupoGasto, {
  as: "Categoria",
  foreignKey: "categoriaId",
  onDelete: "CASCADE",
});

CatPresupuestoGrupoGasto.belongsTo(Estado, {
  as: "Estado",
  foreignKey: "estadoId",
  onDelete: "CASCADE",
});
CatPresupuestoGrupoGasto.belongsTo(CatMes, {
  as: "Mes",
  foreignKey: "mesId",
  onDelete: "CASCADE",
});
CatPresupuestoGrupoGasto.hasMany(PresupuestoDetalleGrupoGasto, {
  as: "Detalle",
  foreignKey: "presupuestoId",
  onDelete: "CASCADE",
});

PresupuestoDetalleGrupoGasto.belongsTo(CatCategoriaGrupoGasto, {
  as: "Categoria",
  foreignKey: "categoriaId",
  onDelete: "CASCADE",
});

// CatPerfilGrupoGasto.belongsTo(Estado, {
//   as: "Estado",
//   foreignKey: "estadoId",
//   onDelete: "CASCADE",
// });

// PerfilAccesoGrupoGasto.belongsTo(Estado, {
//   as: "Estado",
//   foreignKey: "estadoId",
//   onDelete: "CASCADE",
// });

// PerfilAccesoGrupoGasto.belongsTo(CatAccessoGrupoGasto, {
//   as: "Acceso",
//   foreignKey: "accesoId",
//   onDelete: "CASCADE",
// });

GastoGrupoGasto.belongsTo(Estado, {
  as: "Estado",
  foreignKey: "estadoId",
  onDelete: "CASCADE",
});

GastoGrupoGasto.belongsTo(CatCategoriaGrupoGasto, {
  as: "Categoria",
  foreignKey: "categoriaId",
  onDelete: "CASCADE",
});

GastoGrupoGasto.belongsTo(SubCategoriaGrupoGasto, {
  as: "SubCategoria",
  foreignKey: "sub_categoriaId",
  onDelete: "CASCADE",
});
  ...
  confiBd.sync({
    ...
    confiBd.query("select count(*) as total from cat_estado", {
      ...
      if (resultado[0].total === 0) {
        ...
        await CatMes.bulkCreate(listMeses);
        await CatMoneda.bulkCreate(listMonedas);
      //  await CatPerfilGrupoGasto.bulkCreate(listPerfilGrupoGasto);
        await CatAccessoGrupoGasto.bulkCreate(listAccesoGrupoGasto);
      //  await PerfilAccesoGrupoGasto.bulkCreate(listAccesoPerfilGrupoGasto);
      }
    });
  });
} catch (e) {
...
module.exports = {
  ...
  CatMes,
  CatGrupoGasto,
  CatAccessoGrupoGasto,
  //CatPerfilGrupoGasto,
  //PerfilAccesoGrupoGasto,
  GrupoGastoUsuario,
  CatCategoriaGrupoGasto,
  SubCategoriaGrupoGasto,
  CatPresupuestoGrupoGasto,
  PresupuestoDetalleGrupoGasto,
  GastoGrupoGasto,
  ConfirmarCuenta,
  InvitacionGrupoGasto,
  UsuarioAccesoGrupoGasto,
  bd: confiBd
}
