    ...
    if (dataAnterior) {
        ...
        if (resultado > 0) {
            ...
            req.body.usuario_ult_mod = usuarioId;
             await registrarBitacora(req,tabla, estado_civilId, dataAnterior.dataValues, req.body);
...
const eliminar = async (req) => {
    ...
    if (dataAnterior) {
        ...
        if (resultado > 0) {
            ...
            await registrarBitacora(req,tabla, estado_civilId, dataAnterior.dataValues, dataEliminar);
