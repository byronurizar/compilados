...
const update = async (req) => {
    ...
    if (dataAnterior) {
        ...
        if (resultado > 0) {
            ...
            await registrarBitacora(req,tabla, menuId, dataAnterior.dataValues, req.body);
...
const eliminar = async (req) => {
    ...
    if (dataAnterior) {
        ...
        if (resultado > 0) {
            ...
            await registrarBitacora(req,tabla, menuId, dataAnterior.dataValues, dataEliminar);
